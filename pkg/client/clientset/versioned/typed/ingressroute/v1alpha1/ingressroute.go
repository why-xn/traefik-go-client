...
import (
	...
	scheme "github.com/why-xn/traefik-go-client/pkg/client/clientset/versioned/scheme"
...
func newIngressRoutes(c *IngressrouteV1alpha1Client, namespace string) *ingressRoutes {
