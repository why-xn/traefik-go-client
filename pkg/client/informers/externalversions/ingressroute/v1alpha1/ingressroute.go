...
import (
	...
	ingressroutev1alpha1 "github.com/why-xn/traefik-go-client/pkg/apis/ingressroute/v1alpha1"
	versioned "github.com/why-xn/traefik-go-client/pkg/client/clientset/versioned"
	internalinterfaces "github.com/why-xn/traefik-go-client/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/why-xn/traefik-go-client/pkg/client/listers/ingressroute/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IngressrouteV1alpha1().IngressRoutes(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IngressrouteV1alpha1().IngressRoutes(namespace).Watch(options)
			},
		},
		&ingressroutev1alpha1.IngressRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *ingressRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ingressroutev1alpha1.IngressRoute{}, f.defaultInformer)
}
